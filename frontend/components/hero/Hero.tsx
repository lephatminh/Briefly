...
export default function Hero(props: Props) {
  return (
    <section className={`flex flex-col justify-center items-center ${props.className}`}>
      ...
      <h1 className="text-[#232323] dark:text-white md:text-7xl text-5xl font-semibold tracking-wide mt-2 line-through decoration-white dark:decoration-[#232323] decoration-4">
        Briefly
      </h1>
